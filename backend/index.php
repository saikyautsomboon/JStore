<?php require('backendheader.php'); 
    ...
    $sql = "SELECT count(id) as ordertotal FROM orders WHERE status=:status";
...
<div class="content-wrapper">
    ...
    <!-- go to this link to get Icon https://ionic.io/ionicons/v2  -->
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-6">
                    ...
                    <div class="small-box bg-warning">
                        <div class="inner">
                            <h3><?= $customercount['customertotal']?></h3>
                ...
                <section class="col-lg-12 connectedSortable">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">
                                <i class="fas fa-chart-pie mr-1"></i> Monthly Sales
                            </h3>
