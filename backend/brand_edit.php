...
<div class="content-wrapper">
    ...
    <div class="content-heade mx-4">
        <div class="container-fluid ">
            <div class="row mb-4 ">
                <div class="col-sm-9 ">
                    <h1 class="m-0">Brand Edit Form</h1>
                </div>
                <!-- /.col -->
                    ...
                    <div class="title-body mx-4">
                        ...
                        <input type='hidden' name='oldphoto' value="<?= $brand['logo'] ?>">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10"><input type="text" class="form-control" placeholder="" id="name_id" name="name" value="<?= $brand['name'] ?>"></div>
                                        ...
                                        <div class="nav nav-tabs" id="nav-tab" role="tablist">
                                            ...
                                            <div class="tab-content my-3 " id="myTabContent">
                                                <div class="tab-pane fade show active" id="photo" role="tabpanel" aria-labelledby="photo-tab" >
                                                    <img src="<?php echo $brand['logo'] ?>" class="img-fluid">
